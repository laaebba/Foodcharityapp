...
import com.example.hp.googlemapsgoogleplaces.CustomInfoWindowAdapter;
import com.example.hp.googlemapsgoogleplaces.GetNearbyPlaces;
import com.example.hp.googlemapsgoogleplaces.PlaceAutocompleteAdapter;
...
//    private FusedLocationProviderClient mFusedLocationClient;
    ...
    public void onClick(View v) {
        ...
        String non_govermental= "charity", restaurant = "restaurant";
        ...
        switch (v.getId()) {
            ...
            case R.id.charityhomes_nearby:
                mMap.clear();
                String url = getUrl(latitide, longitude, non_govermental);
                transferData[0] = mMap;
                transferData[1] = url;

                getNearbyPlaces.execute(transferData);
                Toast.makeText(this, "Searching for Nearby Charity homes...", Toast.LENGTH_SHORT).show();
                Toast.makeText(this, "Showing Nearby ch...", Toast.LENGTH_SHORT).show();
                break;
